...
- `sans-site` reçoit son propre tableau. 4 entrées sur 13 restent identiques au socle (aucune promesse « ce soir »/« site fini »/rappel demain à corriger) : « Je suis déjà sur Google. », « Combien ça coûte ? », « C'est vous l'IA, un robot ? », « Comment vous avez eu mon numéro ? ». Les 9 autres sont reformulées pour coller au nouveau script (parle d'« exemple » plutôt que de « site », envoyé par courriel/texto, pas de promesse de délai précis, pas de rappel demain garanti) — y compris « C'est quoi l'arnaque, c'est gratuit ? » et « Je marche au bouche à oreille... », qui échangent « le site »/« je le supprime » contre un vocabulaire « exemple » :
